<template>
	<div
		...
		@touchend="onTouchEnd"
	>
		<Navbar v-if="shouldShowNavbar" @toggle-sidebar="toggleSidebar" :shouldShowSidebar="shouldShowSidebar"/>
	...
	methods: {
		...
		switchSidebar() {
			if(this.shouldShowSidebar){
				...
				// 	return;
				// }
				if (document.body.offsetWidth >= 703) {
					if (sidebar.offsetWidth > 100) {
						sidebar.style.width = "0";
						page.style.paddingLeft = "0";
					} else {
						sidebar.style.width = "18rem";
						page.style.paddingLeft = "18rem";
					}
				}
			}
